...
mycode = '''
# friends similarity
follower = pd.read_csv('D:/MBAN/Term 2/Data Science 2/Project 2/One_Match/test.csv')
...
user_i = pd.read_csv('D:\MBAN\Term 2\Data Science 2\Project 2\One_Match\int1.csv')
...
for i in (1,100,10000):
    print ("Execution Time(in seconds) for %d iterations of code: " %i, timeit.timeit(setup = mysetup, stmt = mycode, number = i))
